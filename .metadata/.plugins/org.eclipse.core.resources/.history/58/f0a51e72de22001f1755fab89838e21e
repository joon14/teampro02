 	    ...
 	    <section class="page" id="page1">
    		<div class="page-wrap">
	    		<div class="clr-fix">
		            ...
		            <hr>
		            <form action="${path }/member/myUpdatePro.do" method="post">
		                <div class="table_form_wrap">
		                    <table class="table_form">
		                        ...
		                        <tr>
		                            ...
		                            <td>
		                                <input type="text" name="addr1" id="addr1" class="input" value="${cus.addr }"><br>
		                                <input type="text" name="addr2" id="addr2" class="input" value="${cus.addr }"><br>
		                        ...
		                        <tr>
		                            <th><label for="payment">소비 누적금액</label></th>
		                            <td><input type="text" name="payment" id="payment" class="input" value="${cus.payment }" ></td>
		                        </tr>
		                        <tr>
		                            <td colspan="2">
		                            	<div class="buttons">
