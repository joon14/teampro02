            ...
            <form action="${path}/product/insProduct.do" method="post" enctype="multipart/form-data">
                ...
                <div class="field">
                 ...
                 <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="text" name="context" placeholder="제품 상세 내용">
                    </div>
                </div>
                ...
                <div class="field">
                 ...
                 <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="file" name="img2" id="img2" required>
                    </div>
                </div>
                 ...
                 <div class="field">
                    ...
                    <div class="control">
                        <input class="input" type="file" name="img3" id="img3" required>
                    </div>
                </div>
